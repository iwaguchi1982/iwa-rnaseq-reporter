...
> [!NOTE]
> **開発者・解析エンジニアの方へ**
> このアプリの技術的な責務境界（Responsibility & Boundary）や設計思想については、[Developer_README.md](Developer_README.md) を参照してください。
...
## 9. 開発者向けドキュメント
技術的な仕様や設計の詳細は [Developer_README.md](Developer_README.md) を参照してください。
